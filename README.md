...
- [~] **Step 6 — AI engine** *(core delivered)* — FastAPI service with in-house TA indicators (RSI/MACD/EMA/ATR/ADX/Bollinger/VWAP/SuperTrend/Stochastic) + an **explainable** BUY/SELL/NO_TRADE/WATCH signal engine, **candlestick pattern detection** (12 patterns) and **support/resistance level detection**; 21 pytest tests pass, verified on live Binance candles. Node↔Python bridge wired & verified cross-service. Next: SMC engine, multi-timeframe confluence, ML forecasting, vision, LLM narrative
